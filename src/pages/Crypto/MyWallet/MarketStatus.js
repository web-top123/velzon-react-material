                ...
                <CardHeader className="border-bottom-dashed d-flex align-items-center">
                    ...
                    <div className="flex-shrink-0">
                        <div className="btn-group shadow" role="group" aria-label="Basic example">
                            <button type="button" className="btn btn-primary btn-sm shadow-none">Today</button>
                            <button type="button" className="btn btn-outline-primary btn-sm shadow-none">Overall</button>
                        </div>
                    </div>
                </CardHeader>
                <CardBody>
