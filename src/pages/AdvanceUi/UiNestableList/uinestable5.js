                                ...
                                <ListGroupItem className="nested-1">
                                    <div className="d-flex align-items-center">
                                        <div className="avatar-xs flex-shrink-0 me-3">
                                            <img src={avatar1} alt="" className="img-fluid rounded-circle shadow" />
                                        </div>
                                                    ...
                                                    <React.Fragment key={key}>
                                                        <ListGroup className="nested-list nested-sortable" key={key}>
                                                            <ListGroupItem className="nested-3">
                                                                <div className="d-flex align-items-center">
                                                                    <div className="avatar-xs flex-shrink-0 me-3">
                                                                        <img src={item.img} alt="" className="img-fluid rounded-circle shadow" />
                                                                    </div>
                                                                    <div className="flex-grow-1">
                                                                ...
                                                                <ListGroup className="nested-list nested-sortable">
                                                                    {item.set1.map((item, key) => (<ListGroupItem className="nested-4" key={key}>
                                                                        <div className="d-flex align-items-center">
                                                                            <div className="avatar-xs flex-shrink-0 me-3">
                                                                                <div className="avatar-title rounded-circle shadow">
                                                                                    {item.img ? <img src={item.img} alt="" className="img-fluid rounded-circle shadow" /> : <i className="ri-user-2-fill"></i>}
                                                                                </div>
                                                                            </div>
                                                                            <div className="flex-grow-1">
                                                                                <h5 className="fs-14 mb-0">{item.name}</h5>
