                    ...
                    <TabContent activeTab={activeTab}>
                        <TabPane tabId="1">
                            ...
                            <SimpleBar style={{ height: "508px" }} className="px-3 mx-n3 mb-2">
                                <div className="d-flex mb-4">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        ...
                                        <div className="d-flex mt-4">
                                            <div className="flex-shrink-0">
                                                <img src={avatar10} alt="" className="avatar-xs rounded-circle shadow-none" />
                                            </div>
                                            <div className="flex-grow-1 ms-3">
                                ...
                                <div className="d-flex mb-4">
                                    <div className="flex-shrink-0">
                                        <img src={avatar8} alt="" className="avatar-xs rounded-circle shadow-none" />
                                    </div>
                                    <div className="flex-grow-1 ms-3">
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        ...
                                        <Row className="g-2 mb-3">
                                            <Col lg={1} sm={2} xs={6}>
                                                <img src={image4} alt="" className="img-fluid rounded shadow-none" />
                                            </Col>
                                            <Col lg={1} sm={2} xs={6}>
                                                <img src={image5} alt="" className="img-fluid rounded shadow-none" />
                                            </Col>
                                        </Row>
                                        <Link to="#" className="badge text-muted bg-light"><i className="mdi mdi-reply"></i> Reply</Link>
                                        <div className="d-flex mt-4">
                                            <div className="flex-shrink-0">
                                                <img src={avatar6} alt="" className="avatar-xs rounded-circle shadow-none" />
                                            </div>
                                            <div className="flex-grow-1 ms-3">
