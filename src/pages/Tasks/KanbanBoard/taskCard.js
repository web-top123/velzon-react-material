                            ...
                            <Card className="tasks-box" >
                                <CardBody>
                                    <div className="d-flex mb-2">
                                        <h6 className="fs-15 mb-0 flex-grow-1 text-truncate">{data.isTaskIdHeader ? <Link to="#" className="text-muted fw-medium fs-14 flex-grow-1">{data.taskId}</Link> : <Link to="/apps-tasks-details" className="text-body">{data.title}</Link>}</h6>
                                    ...
                                    {data.isTaskId && <div className="mb-3">
                                        ...
                                        <div className={"progress rounded-3 progress-sm bg-soft-" + data.progressBarColor}>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-shrink-0">
                                            <div className="avatar-group">
                                                {map(data.members, (data, key) => (<Link to="#" className="avatar-group-item shadow" key={key}>
                                ...
                                {data.isProgessBarFooter && <div className={"progress progress-sm bg-soft-" + data.progressBarColor}>
