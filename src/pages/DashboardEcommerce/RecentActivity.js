              ...
              <div className="p-3">
                ...
                <div className="mt-3">
                  <Row className="align-items-center g-2">
                    ...
                    <div className="col">
                      <div className="p-1">
                        <div className="progress bg-soft-success animated-progess progress-sm">
                          <div
                  ...
                  <Row className="align-items-center g-2">
                    ...
                    <div className="col">
                      <div className="p-1">
                        <div className="progress bg-soft-warning animated-progess progress-sm">
                          <div
                  ...
                  <Row className="align-items-center g-2">
                    ...
                    <div className="col">
                      <div className="p-1">
                        <div className="progress bg-soft-danger animated-progess progress-sm">
                          <div
