                ...
                <Col xxl={4} xl={6}>
                    <Card className="card-height-100">
                        <CardHeader className="align-items-center d-flex">
                            ...
                            <div>
                                <Button color="secondary" size="sm" className="btn-soft-secondary shadow-none me-1">
                                    ALL
                                </Button>
                                <Button color="primary" size="sm" className="btn-soft-primary shadow-none me-1">
                                    1M
                                </Button>
                    ...
                    <Card className="card-height-100">
                        ...
                        <CardBody>
                            ...
                            <div className="px-2 py-2 mt-1">
                                ...
                                <Progress color="primary" value={75} striped className="mt-2 bg-soft-primary" style={{ height: "6px" }} />

                                <p className="mt-3 mb-1">California <span className="float-end">47%</span></p>
                                <Progress color="primary" value={47} striped className="mt-2 bg-soft-primary" style={{ height: "6px" }} />

                                <p className="mt-3 mb-1">Texas <span className="float-end">82%</span></p>
                                <Progress color="primary" value={82} striped className="mt-2 bg-soft-primary" style={{ height: "6px" }} />
                            </div>
                        </CardBody>
                    </Card>
                </Col>
                                ...
                                {(widgetsPortfolio || []).map((item, key) => (<ListGroupItem className="px-0" key={key}>
                                    <div className="d-flex">
                                        <div className="flex-shrink-0 avatar-xs">
                                            <span className="avatar-title bg-light p-1 rounded-circle shadow">
