...
<div className="mb-4">
    ...
    <Progress color="success" value={40} className="progress-sm bg-soft-success" />
</div>

<!-- Prgress lg -->
<div className="mb-4">
    <h5 className="fs-13">Large Progress</h5>
    <Progress color="warning" value={50} className="progress-sm bg-soft-warning" />
</div>

<!-- Prgress xl -->
<div>
    <h5 className="fs-13">Extra Large Progress</h5>
    <Progress color="danger" value={70} className="progress-sm bg-soft-danger" />
</div>
`;
...
<div className="mb-4">
    <Progress value={25} color="success" className="animated-progess bg-soft-success" />
</div>
<div className="mb-4">
    <Progress value={50} color="info" className="animated-progess bg-soft-info" />
</div>
<div className="mb-4">
    <Progress value={75} color="warning" className="animated-progess bg-soft-warning" />
</div>
<div>
    <Progress value={100} color="danger" className="animated-progess bg-soft-danger" />
</div>
`;
