...
<!-- Dark Alert -->
<Alert color="dark" className="shadow">
...
<!-- Light Alert -->
<Alert color="light" className="alert-borderless shadow bg-light">
    <strong>Mind Your Step!</strong> A simple <b>light alert</b> —check it out!
</Alert>
...
<!-- Danger Alert -->
<UncontrolledAlert color="danger" className="shadow>
...
<!-- Dark Alert -->
<UncontrolledAlert color="dark" className="shadow>
...
<!-- Danger Alert -->
<UncontrolledAlert color="danger" className="alert-outline shadow">
...
<!-- Dark Alert -->
<UncontrolledAlert color="dark" className="alert-outline shadow">
...
<!-- Danger Alert -->
<UncontrolledAlert color="danger" className="alert-border-left shadow">
...
<!-- Dark Alert -->
<UncontrolledAlert color="dark" className="alert-border-left shadow">
...
<!-- Danger Alert -->
<UncontrolledAlert color="danger" className="alert-solid alert-label-icon shadow">
...
<!-- Dark Alert -->
<UncontrolledAlert color="dark" className="alert-solid alert-label-icon shadow">
...
<!-- Danger Alert -->
<UncontrolledAlert color="danger" className="alert-top-border shadow">
...
<!-- Dark Alert -->
<UncontrolledAlert color="dark" className="alert-top-border shadow">
...
<!-- Danger Alert -->
<UncontrolledAlert color="danger" className="alert-label-icon label-arrow shadow">
...
<!-- Dark Alert -->
<UncontrolledAlert color="dark" className="alert-label-icon label-arrow shadow">
...
<!-- Danger Alert -->
<UncontrolledAlert color="danger" className="alert-additional shadow">
<div className="alert-body">
    <div className="d-flex">
        <div className="flex-shrink-0 me-3">
...
<!-- Warning Alert -->
<UncontrolledAlert color="warning" className="alert-additional shadow">
<div className="alert-body">
    <div className="d-flex">
        <div className="flex-shrink-0 me-3">
            <i className="ri-alert-line fs-16 align-middle"></i>
...
<!-- Danger Alert -->
<Alert color="danger" className="alert-solid shadow">
